...
public class SeatReservationTest {
    ...
    /**
     * A flight designator with less than 4 characters is not allowed. This test
     * checks that
    ...
    /**
     * This test checks that IllegalArgumentException is thrown when a null flight
    ...
    /**
     * A flight designator with more than 6 characters is not allowed. This test
     * checks that
